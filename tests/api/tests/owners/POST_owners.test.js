...
ownerFixture(
  "Create a new pet owner @smoke @bug",
...
ownerFixture(
  "Create a new pet owner without firstName - BAD REQUEST",
...
ownerFixture(
  "Create a new pet owner without lastName - BAD REQUEST",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
...
ownerFixture(
  "Create a new pet owner without body - BAD REQUEST",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
