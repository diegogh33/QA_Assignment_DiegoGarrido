...
ownerFixture(
  "Get a pet owner by ID @smoke",
  async ({ apiContext, requestUtils, responseUtils, ownerSchema, endPoints }) => {
    const { ownerId, firstName, lastName, address, city, telephone } =
      ownerData.getOwnerSuccess;
...
ownerFixture(
  "Get a pet owner by -NOT FOUND- ID @bug",
...
ownerFixture(
  "Get a pet owner by Invalid ID - Bad Request",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
...
ownerFixture(
  "Get a pet owner by Empty ID - Bad Request",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
