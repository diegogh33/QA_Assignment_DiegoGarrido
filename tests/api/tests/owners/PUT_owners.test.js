...
test("Edit an owner @smoke", async ({
  apiContext,
  requestUtils,
  responseUtils,
  ownerSchema,
...
test("Edit an owner without firstName -  BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Edit an owner without lastName -  BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Edit an owner with Empty Body - BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Edit an owner with -Not Found- Owner ID @bug", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Edit an owner with Invalid Owner ID - BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Edit an owner with Empty Owner ID - BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
