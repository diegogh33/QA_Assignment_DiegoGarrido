...
test("Create a new pet @smoke @bug", async ({
  apiContext,
  requestUtils,
  responseUtils,
  petSchema,
  ...
  const response = await requestUtils.postRequest(apiContext, endPoints.PET_BY_OWNER_ID, pet, {
    ownerId,
  });
...
test("Create a new pet without name - BAD REQUEST @bug", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Create a new pet with empty body request - Server Error", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Create a new pet for NOT FOUND ownerID @bug", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Create a new pet for Invalid ownerID - BAD REQUEST", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
...
test("Create a new pet for Empty ownerID - Method Not Allowed", async ({
  apiContext,
  requestUtils,
  responseUtils,
  errorSchema,
