...
petFixture(
  "Get a different pet by Pet ID for the same owner @bug",
  async ({ apiContext, requestUtils, responseUtils, petSchema, endPoints }) => {
...
petFixture(
  "Get a pet with NOT FOUND Owner ID @bug",
...
petFixture(
  "Get a pet with NOT FOUND Pet ID @bug",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
...
petFixture(
  "Get a pet by Invalid Owner ID - BAD REQUEST @bug",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
...
petFixture(
  "Get a pet by Invalid Pet ID - BAD REQUEST",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
...
petFixture(
  "Get a pet by Empty Owner ID - NOT FOUND",
  async ({ apiContext, requestUtils, responseUtils, errorSchema, endPoints }) => {
